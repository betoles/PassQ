...
<body>
  <div class="header">
    ...
    <div style="text-align: center; background: #ffffff; padding: 4px; border: 1px solid #cbd5e1; border-radius: 6px;">
      <img src="${o}" style="width: 92px; height: 92px; display: block; image-rendering: -webkit-optimize-contrast; image-rendering: pixelated; shape-rendering: crispEdges;" alt="GS1 Digital Link QR" />
